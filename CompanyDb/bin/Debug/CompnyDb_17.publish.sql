...
ALTER VIEW [dbo].[viEmployee]
	AS SELECT [Employee].[Id],  [Employee].[FirstName],  [Employee].[LastName],  [Employee].[Birthday],  [Employee].[DepartmentId], [Address].[Zip], [Address].[City], [Address].[Street], [Address].[Country] FROM [Employee] 
	LEFT JOIN [Address]
