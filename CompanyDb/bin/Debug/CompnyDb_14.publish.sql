...
ALTER VIEW [dbo].[viCompany]
	AS SELECT [Company].[Name],  COUNT(Company2Address.AddressId) AS LocationNumber FROM [Company2Address] 
...
GO
PRINT N'Altering [dbo].[viEmployee]...';


GO
ALTER VIEW [dbo].[viEmployee]
	AS SELECT [Id], [FirstName], [LastName], [Birthday], [DepartmentId] FROM [Employee] WHERE [DeleteTime] IS NULL
GO
